# Milestones: Pocket Monsters Ultra Moon

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-UltraMoon-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Ultra Moon |
...
Coordinate with Ultra Sun and compare against Sun/Moon using explicit versioned manifests.
