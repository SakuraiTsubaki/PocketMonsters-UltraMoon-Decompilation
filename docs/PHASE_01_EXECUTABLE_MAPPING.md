...
Establish a reproducible executable baseline for the exact local Pokémon Ultra Moon target before function naming or source reconstruction begins.
...
python tools/inventory_extracted_tree.py /path/to/extracted-game \
  --project "Pokemon Ultra Moon" --platform "Nintendo 3DS" \
