...
Establish the first verified source-reconstruction map for **Pokémon Ultra Moon** from local extracted metadata while keeping original game binaries out of Git.
